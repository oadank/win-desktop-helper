...
C:\Windows\Microsoft.NET\Framework64\v4.0.30319\csc.exe -nologo -target:winexe -optimize+ ^
  ...
  AssemblyInfo.cs shot-service.cs shot-capture.cs shot-ocr.cs shot-translate.cs shot-config.cs shot-automation.cs shot-pick.cs shot-pick-ui.cs shot-longshot.cs
